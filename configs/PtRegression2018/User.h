...
namespace PtRegression2018_cfg {
  ...
  inline void ConfigureUser( const TString USER ) {
    ...
    EOS_DIR_NAME = "root://cmseos.fnal.gov//store/user/dildick/SingleMu_Run3_Pt1to50OneOverPt_noPU_10M/crab_SingleMu_Run3_Pt1to50OneOverPt_noPU_10M_DIGI_L1_20210401/210401_131420/0000/";
    in_dir = "";
