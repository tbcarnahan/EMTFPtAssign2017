...
#for iEvt in range(evt_tree.GetEntries()):
  ...
  ME1_phi_p_o=0 ; ME2_phi_p_o=0 ; ME3_phi_p_o=0 ; ME4_phi_p_o=0
  ME1_phi_n_o=0 ; ME2_phi_n_o=0 ; ME3_phi_n_o=0 ; ME4_phi_n_o=0
  ...
  for j in range(2):
	...
	#if evt_tree.hit_chamber[i]%2!=0:
	  #if evt_tree.hit_isCSC[i]==1 and evt_tree.hit_station[i]==1 and evt_tree.hit_endcap[i]==1: ME1_phi_p_o = evt_tree.hit_phi[i]
	  #if evt_tree.hit_isCSC[i]==1 and evt_tree.hit_station[i]==1 and evt_tree.hit_endcap[i]==-1: ME1_phi_n_o = evt_tree.hit_phi[i]
	  #if evt_tree.hit_isCSC[i]==1 and evt_tree.hit_station[i]==2 and evt_tree.hit_endcap[i]==1: ME2_phi_p_o = evt_tree.hit_phi[i]
	  #if evt_tree.hit_isCSC[i]==1 and evt_tree.hit_station[i]==2 and evt_tree.hit_endcap[i]==-1: ME2_phi_n_o = evt_tree.hit_phi[i]
	  #if evt_tree.hit_isCSC[i]==1 and evt_tree.hit_station[i]==3 and evt_tree.hit_endcap[i]==1: ME3_phi_p_o = evt_tree.hit_phi[i]
	  #if evt_tree.hit_isCSC[i]==1 and evt_tree.hit_station[i]==3 and evt_tree.hit_endcap[i]==-1: ME3_phi_n_o = evt_tree.hit_phi[i]
	  #if evt_tree.hit_isCSC[i]==1 and evt_tree.hit_station[i]==4 and evt_tree.hit_endcap[i]==1: ME4_phi_p_o = evt_tree.hit_phi[i]
	  #if evt_tree.hit_isCSC[i]==1 and evt_tree.hit_station[i]==4 and evt_tree.hit_endcap[i]==-1: ME4_phi_n_o = evt_tree.hit_phi[i]
  ...
  ##Fill dTheta bendings into 1D histograms.
  ...
  #Fill Bending vs pT 2D histograms.
