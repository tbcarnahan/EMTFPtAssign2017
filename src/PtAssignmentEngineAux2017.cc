#include "../interface/PtAssignmentEngineAux2017.h"
#include <iostream>
#include <cassert>
#include <cmath>

// From here down, exact copy of code used in emulator: L1Trigger/L1TMuonEndCap/src/PtAssignmentEngineAux2017.cc
...
int PtAssignmentEngineAux2017::getCLCT(int clct, int endcap, int dPhiSign, int bits, bool isRun2) const {
  ...
  // For endcap=-1: (-15, -14, ..., -8) -> 0,  (-7, -6, ..., 0) -> 1,  (1, 2, ..., 7) -> 2,  (8, 9, ..., 15) -> 3
  //     endcap= 1:                     -> 3,                   -> 2,                 -> 1,                  -> 0
